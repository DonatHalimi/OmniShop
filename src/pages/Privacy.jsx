...
/*
 ...
 - Displays the privacy policy of OmniShop.
 - It includes information on data collection, usage, security, cookies, and links to other websites.
*/
...
export const Privacy = () => {
    ...
    return (
        <>
            ...
            <div className="container mx-auto px-20 py-8" style={{ marginTop: '110px' }}>
                <div className="container mx-auto px-4 py-8">
                    <h1 className="text-3xl font-bold mb-4">Privacy Policy</h1>

                    <p className="mb-4">
                        This privacy policy sets out how OmniShop uses and protects any information that you give us when you use
                        this
                        website.
                    </p>
                    ...
                    <ul className="list-disc list-inside mb-4">
                        <li>If you have previously agreed to us using your personal information for direct marketing purposes,
                            you may change your mind at any time by writing to or emailing us at <a href='mailto:omnishop@support.com' style={{ textDecoration: 'underline' }}>omnishop@support.com</a>.</li>
                        ...
                        <li>You may request details of personal information which we hold about you. If you would like a copy of the
                            ...
                            <a href='mailto:omnishop@support.com' style={{ textDecoration: 'underline' }}> omnishop@support.com</a>.</li>
